...
\subsection{Implementation}
    ...
    \begin{itemize}
        \item \textbf{Texture-based Blue Noise:} Utilizing a $64 \times 64$ tiling texture to maximize high-frequency energy. subtracting decorrelated samples (obtained via spatial offsetting) to generate the 2D offset vector.
...
\subsection{Results \& Evaluation}
    ...
    Demonstrate that AJWD exposes simply adds way too much noise, or, if we reduce the amplitude, doesn't add enough in one axis.
